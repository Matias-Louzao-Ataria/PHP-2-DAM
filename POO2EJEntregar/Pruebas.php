...
require("Persona Matias Louzao Ataria.php");
require("Noria Matias Louzao Ataria.php");
...
$n -> inicioViaje($p4);
echo "<br>";
echo "Hay ".$n -> getPasajerosActuales()." pasajeros actualmente en la noria!";
echo "<br>";
$n -> ListaPasajeros();
echo '<br>';
//$n -> finViaje($p);
...
//$n -> ListaPasajeros();
$n -> listaVigueses();
echo "Se han subido un total de: ".$n -> getTotalClientes()." personas a la noria!";
?>
